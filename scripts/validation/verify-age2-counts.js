// Verify Age II card counts match expected distribution
const fs = require('fs');
const path = require('path');

// Read the TypeScript file and extract copy counts
const filePath = path.join(__dirname, 'packages/shared/src/data/cards/age2Templates.ts');
...
console.log('=== AGE II CARD COUNT VERIFICATION ===\n');
